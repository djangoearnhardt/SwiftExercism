...
func etl(legacyScores: [Int : [String]]) -> [String: Int] {
    var updatedScores: [String : Int] = [:]
    for dict in legacyScores {
        for eachLetter in dict.1 {
            updatedScores[eachLetter] = dict.0
        }
    }
    print(updatedScores)
